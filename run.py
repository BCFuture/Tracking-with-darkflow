...
FLAGS.demo = "/home/aleksartamonov/yolo/darknet/examples/herding_cows.mp4" # video file to use, or if camera just put "camera"
...
FLAGS.trackObj = ['cow', 'sheep'] # the object to be tracked
...
FLAGS.csv_path = 'output_herd.csv'
